...
patch admin car statistics visible by car statistic id Fail With Wrong Url
   ...
   run every case by params  patch admin car statistics visible by car statistic id Fail 404  ${essential_params}  ${unessential_params}    car_statistic_id/visible=${w}
...
patch admin car statistics visible by car statistic id Success 
   ...
   ${essential_params}  create list  visible=False  
   ${unessential_params}  create list  
   run every case by params  patch admin car statistics visible by car statistic id Success 204  ${essential_params}  ${unessential_params}    car_statistic_id/visible=${car_statistic_id/visible}
...
patch admin car statistics visible by car statistic id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin car statistics visible by car statistic id Fail 422  ${essential_params}  ${unessential_params}    car_statistic_id/visible=${car_statistic_id/visible}  success=False
