...
patch admin car statistics visible by car statistic id Fail Without Login
   ...
   run every case by params  patch admin car statistics visible by car statistic id Fail 403  ${essential_params}  ${unessential_params}    car_statistic_id/visible=${car_statistic_id/visible}
