...
patch admin car washer statistics visible by username Fail With Wrong Url
   ...
   run every case by params  patch admin car washer statistics visible by username Fail 404  ${essential_params}  ${unessential_params}    username/visible=${w}
...
patch admin car washer statistics visible by username Success 
   ...
   ${essential_params}  create list  visible=False  
   ${unessential_params}  create list  
   run every case by params  patch admin car washer statistics visible by username Success 204  ${essential_params}  ${unessential_params}    username/visible=${username/visible}
...
patch admin car washer statistics visible by username Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin car washer statistics visible by username Fail 422  ${essential_params}  ${unessential_params}    username/visible=${username/visible}  success=False
