...
patch admin car washer statistics visible by username Fail Without Login
   ...
   run every case by params  patch admin car washer statistics visible by username Fail 403  ${essential_params}  ${unessential_params}    username/visible=${username/visible}
