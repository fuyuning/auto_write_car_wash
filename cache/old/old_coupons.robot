...
post coupon pools achieve by mobile by coupon pool id Success 
   ...
   run every case by params  post coupon pools achieve by mobile by coupon pool id Success 200  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}
...
post coupon pools achieve by mobile by coupon pool id Fail With Wrong Params
   ...
   run every case by params  post coupon pools achieve by mobile by coupon pool id Fail 422  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}  success=False
...
post coupon pools achieve by mobile by coupon pool id Fail With Wrong Url
   ...
   ${essential_params}  create list  mobile=${mobile}  serie=${serie}  captcha=${captcha}  
   ${unessential_params}  create list  client_id=${client_id}  secret=${secret}  
   run every case by params  post coupon pools achieve by mobile by coupon pool id Fail 404  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${w}  coupon_pool_id/achieve=${r}  coupon_pool_id=${o}
...
post coupon pools achieve by coupon pool id Success 
   ...
   [Tags]           Respcode:204
   post coupon pools achieve by coupon pool id Success 204    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}
...
post coupon pools achieve by coupon pool id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   post coupon pools achieve by coupon pool id Fail 404    coupon_pool_id/achieve_by_mobile=${w}  coupon_pool_id/achieve=${r}  coupon_pool_id=${o}
...
get user coupon pools by coupon pool id Success 
   ...
   ${unessential_params}  create list  
   run every case by params  get user coupon pools by coupon pool id Success 200  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}
...
get user coupon pools by coupon pool id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  get user coupon pools by coupon pool id Fail 422  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}  success=False
...
get user coupon pools by coupon pool id Fail With Wrong Url
   ...
   ${essential_params}  create list  is_point=${is_point}  
   ${unessential_params}  create list  
   run every case by params  get user coupon pools by coupon pool id Fail 404  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${w}  coupon_pool_id/achieve=${r}  coupon_pool_id=${o}
