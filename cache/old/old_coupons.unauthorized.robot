...
post coupon pools achieve by coupon pool id Fail Without Login
   ...
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   post coupon pools achieve by coupon pool id Fail 403    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}
...
get user coupon pools by coupon pool id Fail Without Login
   ...
   ${unessential_params}  create list  
   run every case by params  get user coupon pools by coupon pool id Fail 403  ${essential_params}  ${unessential_params}    coupon_pool_id/achieve_by_mobile=${coupon_pool_id/achieve_by_mobile}  coupon_pool_id/achieve=${coupon_pool_id/achieve}  coupon_pool_id=${coupon_pool_id}
