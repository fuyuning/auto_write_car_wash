...
patch admin parking statistics by day visible by parking statistic id Fail Without Login
   ...
   run every case by params  patch admin parking statistics by day visible by parking statistic id Fail 403  ${essential_params}  ${unessential_params}    parking_statistic_id=${parking_statistic_id}


*** Variables ***
${parking_statistic_id}  12345678909876543
