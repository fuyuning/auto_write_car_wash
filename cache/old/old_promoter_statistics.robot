...
patch admin promoter statistics visible by promoter statistic id Fail With Wrong Url
   ...
   run every case by params  patch admin promoter statistics visible by promoter statistic id Fail 404  ${essential_params}  ${unessential_params}    promoter_statistic_id/visible=${w}
...
patch admin promoter statistics visible by promoter statistic id Success 
   ...
   ${essential_params}  create list  visible=False  
   ${unessential_params}  create list  
   run every case by params  patch admin promoter statistics visible by promoter statistic id Success 204  ${essential_params}  ${unessential_params}    promoter_statistic_id/visible=${promoter_statistic_id/visible}
...
patch admin promoter statistics visible by promoter statistic id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin promoter statistics visible by promoter statistic id Fail 422  ${essential_params}  ${unessential_params}    promoter_statistic_id/visible=${promoter_statistic_id/visible}  success=False
