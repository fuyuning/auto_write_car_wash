...
patch admin promoter statistics visible by promoter statistic id Fail Without Login
   ...
   run every case by params  patch admin promoter statistics visible by promoter statistic id Fail 403  ${essential_params}  ${unessential_params}    promoter_statistic_id/visible=${promoter_statistic_id/visible}
