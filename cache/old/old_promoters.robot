...
put admin promoters by promoter id Fail With Wrong Params
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  name=${name_422}  mobile=${mobile_422}  promoter_remark=${promoter_remark_422}  enabled=ThisIsRobot!  
   run every case by params  put admin promoters by promoter id Fail 422  ${essential_params}  ${unessential_params}    promoter_id=${promoter_id}  promoter_id/enabled=${promoter_id/enabled}  success=False
...
put admin promoters by promoter id Success 
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  name=${name}  mobile=${mobile}  promoter_remark=${promoter_remark}  enabled=False  
   run every case by params  put admin promoters by promoter id Success 204  ${essential_params}  ${unessential_params}    promoter_id=${promoter_id}  promoter_id/enabled=${promoter_id/enabled}
...
put admin promoters by promoter id Fail With Wrong Url
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  name=${name}  mobile=${mobile}  promoter_remark=${promoter_remark}  enabled=False  
   run every case by params  put admin promoters by promoter id Fail 404  ${essential_params}  ${unessential_params}    promoter_id=${w}  promoter_id/enabled=${r}
...
patch admin promoters enabled by promoter id Fail With Wrong Url
   ...
   run every case by params  patch admin promoters enabled by promoter id Fail 404  ${essential_params}  ${unessential_params}    promoter_id=${w}  promoter_id/enabled=${r}
...
patch admin promoters enabled by promoter id Success 
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  enabled=False  
   run every case by params  patch admin promoters enabled by promoter id Success 204  ${essential_params}  ${unessential_params}    promoter_id=${promoter_id}  promoter_id/enabled=${promoter_id/enabled}
...
patch admin promoters enabled by promoter id Fail With Wrong Params
   ...
   run every case by params  patch admin promoters enabled by promoter id Fail 422  ${essential_params}  ${unessential_params}    promoter_id=${promoter_id}  promoter_id/enabled=${promoter_id/enabled}  success=False
...
delete admin promoters by promoter id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   delete admin promoters by promoter id Fail 404    promoter_id=${w}  promoter_id/enabled=${r}
...
delete admin promoters by promoter id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   delete admin promoters by promoter id Success 204    promoter_id=${promoter_id}  promoter_id/enabled=${promoter_id/enabled}
