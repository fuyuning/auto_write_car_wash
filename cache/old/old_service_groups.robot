...
get user service groups price by service group id Fail With Wrong Url
   ...
   run every case by params  get user service groups price by service group id Fail 404  ${essential_params}  ${unessential_params}    service_group_id/price=${w}
...
get user service groups price by service group id Success 
   ...
   ${essential_params}  create list  car_series_id=${car_series_id}  
   ${unessential_params}  create list  
   run every case by params  get user service groups price by service group id Success 200  ${essential_params}  ${unessential_params}    service_group_id/price=${service_group_id/price}
...
get user service groups price by service group id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  get user service groups price by service group id Fail 422  ${essential_params}  ${unessential_params}    service_group_id/price=${service_group_id/price}  success=False
