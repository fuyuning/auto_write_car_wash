...
get user user contacts by user contact id Success 
   ...
   [Tags]           Respcode:200
   get user user contacts by user contact id Success 200    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
...
get user user contacts by user contact id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   get user user contacts by user contact id Fail 404    user_contact_id=${w}  user_contact_id/is_default=${r}
...
put user user contacts by user contact id Success 
   ...
   run every case by params  put user user contacts by user contact id Success 204  ${essential_params}  ${unessential_params}    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
...
put user user contacts by user contact id Fail With Wrong Url
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  mobile=${mobile}  name=${name}  car_type=${car_type}  
   run every case by params  put user user contacts by user contact id Fail 404  ${essential_params}  ${unessential_params}    user_contact_id=${w}  user_contact_id/is_default=${r}
...
put user user contacts by user contact id Fail With Wrong Params
   ...
   run every case by params  put user user contacts by user contact id Fail 422  ${essential_params}  ${unessential_params}    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}  success=False
...
put user user contacts is default by user contact id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   put user user contacts is default by user contact id Success 204    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
...
put user user contacts is default by user contact id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   put user user contacts is default by user contact id Fail 404    user_contact_id=${w}  user_contact_id/is_default=${r}
...
delete user user contacts by user contact id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   delete user user contacts by user contact id Fail 404    user_contact_id=${w}  user_contact_id/is_default=${r}
...
delete user user contacts by user contact id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   delete user user contacts by user contact id Success 204    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
