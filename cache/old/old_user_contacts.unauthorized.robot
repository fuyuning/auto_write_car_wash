...
get user user contacts by user contact id Fail Without Login
   ...
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   get user user contacts by user contact id Fail 403    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
...
put user user contacts by user contact id Fail Without Login
   ...
   run every case by params  put user user contacts by user contact id Fail 403  ${essential_params}  ${unessential_params}    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
...
put user user contacts is default by user contact id Fail Without Login
   ...
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   put user user contacts is default by user contact id Fail 403    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
...
delete user user contacts by user contact id Fail Without Login
   ...
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   delete user user contacts by user contact id Fail 403    user_contact_id=${user_contact_id}  user_contact_id/is_default=${user_contact_id/is_default}
