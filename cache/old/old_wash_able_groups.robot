...
get admin wash able groups by wash auto group id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   get admin wash able groups by wash auto group id Fail 404    wash_auto_group_id=${w}  wash_able_group_id=${r}
...
put admin wash able groups by wash able group id Fail With Wrong Url
   ...
   ${essential_params}  create list  name=${name}  group_time_range=${group_time_range}  expect_time=${expect_time}  expect_day=${expect_day}  is_diff_car_type=False  people_num=${people_num}  people_day_num=${people_day_num}  service_groups=${service_groups}  status=${status}  start_time=${start_time}  end_time=${end_time}  day_in_week=${day_in_week}  car_washers=${car_washers}  time_loop_set=${time_loop_set}  
   ${unessential_params}  create list  spec_people_day_num=${spec_people_day_num}  auto_group=False  
   run every case by params  put admin wash able groups by wash able group id Fail 404  ${essential_params}  ${unessential_params}    wash_auto_group_id=${w}  wash_able_group_id=${r}
...
patch admin wash able group by wash able group id Success 
   ...
   run every case by params  patch admin wash able group by wash able group id Success 204  ${essential_params}  ${unessential_params}    wash_auto_group_id=${wash_auto_group_id}  wash_able_group_id=${wash_able_group_id}
...
patch admin wash able group by wash able group id Fail With Wrong Url
   ...
   ${essential_params}  create list  spec_people_day_num=${spec_people_day_num}  
   ${unessential_params}  create list  
   run every case by params  patch admin wash able group by wash able group id Fail 404  ${essential_params}  ${unessential_params}    wash_auto_group_id=${w}  wash_able_group_id=${r}
...
patch admin wash able group by wash able group id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin wash able group by wash able group id Fail 422  ${essential_params}  ${unessential_params}    wash_auto_group_id=${wash_auto_group_id}  wash_able_group_id=${wash_able_group_id}  success=False
