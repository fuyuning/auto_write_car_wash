...
get admin wash user statistics Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create list  
   ${unessential_params}  create list  user_id=${user_id_422}  order_by=${order_by_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
patch admin wash user statistics visible by wash user statistic id Fail With Wrong Url
   ...
   run every case by params  patch admin wash user statistics visible by wash user statistic id Fail 404  ${essential_params}  ${unessential_params}    wash_user_statistic_id/visible=${w}
...
patch admin wash user statistics visible by wash user statistic id Success 
   ...
   ${essential_params}  create list  visible=False  
   ${unessential_params}  create list  
   run every case by params  patch admin wash user statistics visible by wash user statistic id Success 204  ${essential_params}  ${unessential_params}    wash_user_statistic_id/visible=${wash_user_statistic_id/visible}
...
patch admin wash user statistics visible by wash user statistic id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin wash user statistics visible by wash user statistic id Fail 422  ${essential_params}  ${unessential_params}    wash_user_statistic_id/visible=${wash_user_statistic_id/visible}  success=False
