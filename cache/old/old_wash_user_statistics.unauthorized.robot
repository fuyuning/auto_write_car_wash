...
patch admin wash user statistics visible by wash user statistic id Fail Without Login
   ...
   run every case by params  patch admin wash user statistics visible by wash user statistic id Fail 403  ${essential_params}  ${unessential_params}    wash_user_statistic_id=${wash_user_statistic_id}


*** Variables ***
${wash_user_statistic_id}  12345678909876543
