...
class RecordLibrary(CommonLibrary):
    ...
    def get_projects_spots_parking_records_by_project_id_spot_id(self, project_id, spot_id, **kwargs):
        url = "{SERVER_DOMAIN}/projects/{project_id}/spots/{spot_id}/parking_records".format(
            SERVER_DOMAIN=self.SERVER_DOMAIN, project_id=project_id, spot_id=spot_id)
        data = {}
        for k, v in kwargs.items():
    ...
    def get_projects_spots_spot_records_by_project_id(self, project_id, **kwargs):
        url = "{SERVER_DOMAIN}/projects/{project_id}/spots/spot_records".format(
    ...
    def get_projects_spot_spot_records_by_project_id_spot_id(self, project_id, spot_id, **kwargs):
        url = "{SERVER_DOMAIN}/projects/{project_id}/spot/{spot_id}/spot_records".format(
            SERVER_DOMAIN=self.SERVER_DOMAIN, project_id=project_id, spot_id=spot_id)
        data = {}
        for k, v in kwargs.items():
            if k in ("section", ):
