...
class CouponDistributeSettingLibrary(CommonLibrary):
    def post_admin_coupon_distribute_settings(self, **kwargs):
        ...
        for k, v in kwargs.items():
            if k in ("category", "coupon_pool_id", "enabled"):
                data[k] = v
    ...
    def get_coupon_distribute_settings_(invite_register|invite_first)(self):
    ...
    def put_coupon_distribute_settings_(invite_register|invite_first|new_user)(self, **kwargs):
