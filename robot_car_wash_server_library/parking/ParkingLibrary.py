...
class ParkingLibrary(CommonLibrary):
    def post_admin_parkings(self, **kwargs):
        ...
        for k, v in kwargs.items():
            if k in ("parking_name", "alias_name", "wash_area_id", "out_parking_id", "enabled", "lon", "lat", "parking_banners", "use_home_banner", "service_introduce", "address", "use_home_illustrate", "province", "city", "district", "position"):
                data[k] = v
