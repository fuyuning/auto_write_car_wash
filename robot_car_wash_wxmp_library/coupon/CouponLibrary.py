...
class CouponLibrary(CommonLibrary):
    def post_user_coupon_pools_achieve(self, **kwargs):
    ...
    def post_coupon_pools_achieve_by_mobile_by_coupon_pool_id(self, coupon_pool_id, **kwargs):
    ...
    def post_coupon_pools_achieve_by_coupon_pool_id(self, coupon_pool_id):
        url = "{SERVER_DOMAIN}/coupon_pools/{coupon_pool_id}/achieve".format(
            SERVER_DOMAIN=self.SERVER_DOMAIN, coupon_pool_id=coupon_pool_id)
        return self.client.post(url)

    def get_user_coupons_count(self):
        url = "{SERVER_DOMAIN}/user/coupons_count".format(
            SERVER_DOMAIN=self.SERVER_DOMAIN)
        return self.client.get(url)

    def get_user_coupons_usable(self, **kwargs):
