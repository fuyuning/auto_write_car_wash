...
class OrderLibrary(CommonLibrary):
    ...
    def post_orders(self, **kwargs):
        ...
        data = {}
        for k, v in kwargs.items():
            if k in ("wash_group_id", "wash_normal_id", "parking_id", "wxmp_remark", "coupon_id", "service_group_id", "car_id", "mobile", "name", "car_type", "order_type", "user_car_id", "user_contact_id", "car_place", "card_id", "position", "lucky_flop_award_id", "voucher_id"):
                data[k] = v
        return self.client.post(url, json=data)
