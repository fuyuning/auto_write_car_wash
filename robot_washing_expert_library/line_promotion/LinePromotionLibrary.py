...
class LinePromotionLibrary(CommonLibrary):
    ...
    def get_car_wash_line_promotions_records(self, **kwargs):
        url = "{SERVER_DOMAIN}/car_wash/line_promotions_records".format(
            SERVER_DOMAIN=self.SERVER_DOMAIN)
        data = {}
        for k, v in kwargs.items():
            if k in ("car_id", ):
    ...
    def get_car_wash_line_promotions_wash(self, **kwargs):
        url = "{SERVER_DOMAIN}/car_wash/line_promotions_wash".format(
            SERVER_DOMAIN=self.SERVER_DOMAIN)
        data = {}
        for k, v in kwargs.items():
            if k in ("car_id", ):
