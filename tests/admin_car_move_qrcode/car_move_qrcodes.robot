...
post admin car move qrcodes finish by car move qrcode id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   post admin car move qrcodes finish by car move qrcode id fail 404     car_move_qrcode_id=${wrong_url_id}    qrcode_remark=${qrcode_remark}  status=${status}  
...
post admin car move qrcodes finish by car move qrcode id Success 
   ...
   ${unessential_params}  create dictionary  qrcode_remark=${qrcode_remark}  status=${status}  
...
post admin car move qrcodes finish by car move qrcode id Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  qrcode_remark=${qrcode_remark_422}  status=${status_422}  
...
get admin car move qrcodes Success 
   ...
   ${unessential_params}  create dictionary  car_move_qrcode_id=${car_move_qrcode_id}  user_id=${user_id}  mobile=${mobile}  status=${status}  created_section=${created_section}  
...
get admin car move qrcodes Fail With Wrong Params
   ...
   ${unessential_params}  create dictionary  car_move_qrcode_id=${car_move_qrcode_id_422}  user_id=${user_id_422}  mobile=${mobile_422}  status=${status_422}  created_section=${created_section_422}  
