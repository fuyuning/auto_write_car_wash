...
get admin car series prices Fail Without Login
   ...
   [Tags]           Respcode:403
   get admin car series prices fail 403   intelligent_service_id=${intelligent_service_id}    car_brand_name=${car_brand_name}  car_series_name=${car_series_name}  car_scale=${car_scale}  car_model=${car_model}  page_num=${page_num}  page_size=${page_size}  
