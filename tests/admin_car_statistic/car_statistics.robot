...
patch admin car statistics visible by car statistic id Fail With Wrong Url
   ...
   run every case by params  patch admin car statistics visible by car statistic id Fail 404  ${essential_params}  ${unessential_params}    car_statistic_id=${wrong_url_id}
