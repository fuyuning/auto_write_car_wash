...
get admin car washer statistics Success 
   ...
   ${unessential_params}  create dictionary  username=${username}  mobile=${mobile}  section=${section}  order_by=${order_by}  page_num=${page_num}  page_size=${page_size}  
...
get admin car washer statistics Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  username=${username_422}  mobile=${mobile_422}  section=${section_422}  order_by=${order_by_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
patch admin car washer statistics visible by username Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   patch admin car washer statistics visible by username fail 404     username=${wrong_url_id}  visible=False    
