...
post admin cards Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  card_name=${card_name_422}  days=${days_422}  grant_way=${grant_way_422}  price=${price_422}  first_price=${first_price_422}  recharge_price=${recharge_price_422}  first_recharge_price=${first_recharge_price_422}  card_remark=${card_remark_422}  
   ${unessential_params}  create dictionary  auto_recharge=ThisIsRobot!  coupons=${coupons_422}  
...
post admin cards Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  card_name=${card_name}  days=${days}  grant_way=${grant_way}  price=${price}  first_price=${first_price}  recharge_price=${recharge_price}  first_recharge_price=${first_recharge_price}  card_remark=${card_remark}  
   ${unessential_params}  create dictionary  auto_recharge=False  coupons=${coupons}  
...
get admin cards Success 
   ...
   ${unessential_params}  create dictionary  card_id=${card_id}  page_num=${page_num}  page_size=${page_size}  
...
get admin cards Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  card_id=${card_id_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
put admin cards by card id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   put admin cards by card id fail 404     card_id=${wrong_url_id}  card_name=${card_name}  days=${days}  grant_way=${grant_way}  price=${price}  first_price=${first_price}  recharge_price=${recharge_price}  first_recharge_price=${first_recharge_price}  card_remark=${card_remark}    auto_recharge=False  coupons=${coupons}  
