...
get admin card records Success 
   ...
   ${unessential_params}  create dictionary  user_id=${user_id}  mobile=${mobile}  mode=${mode}  created_section=${created_section}  page_num=${page_num}  page_size=${page_size}  
...
get admin card records Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  user_id=${user_id_422}  mobile=${mobile_422}  mode=${mode_422}  created_section=${created_section_422}  page_num=${page_num_422}  page_size=${page_size_422}  
