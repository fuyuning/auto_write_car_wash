...
post admin card sales Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  card_id=${card_id_422}  enabled=ThisIsRobot!  order_by=${order_by_422}  
...
post admin card sales Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  card_id=${card_id}  enabled=False  order_by=${order_by}  
   ${unessential_params}  create dictionary  
...
put admin card sales by card sale id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   put admin card sales by card sale id fail 404     card_sale_id=${wrong_url_id}  card_id=${card_id}  enabled=False  order_by=${order_by}    
