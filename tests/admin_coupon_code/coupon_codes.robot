...
get admin coupon codes export by coupon code record id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   get admin coupon codes export by coupon code record id Fail 404    coupon_code_record_id=${w}  coupon_code_record_id/remark=${r}
...
get admin coupon codes export by coupon code record id Success 
   ...
   [Tags]           Respcode:200
   get admin coupon codes export by coupon code record id Success 200    coupon_code_record_id=${coupon_code_record_id}  coupon_code_record_id/remark=${coupon_code_record_id/remark}
...
patch admin coupon code records remark by coupon code record id Fail With Wrong Url
   ...
   run every case by params  patch admin coupon code records remark by coupon code record id Fail 404  ${essential_params}  ${unessential_params}    coupon_code_record_id=${w}  coupon_code_record_id/remark=${r}
...
patch admin coupon code records remark by coupon code record id Success 
   ...
   ${essential_params}  create list  coupon_code_remark=${coupon_code_remark}  
   ${unessential_params}  create list  
   run every case by params  patch admin coupon code records remark by coupon code record id Success 204  ${essential_params}  ${unessential_params}    coupon_code_record_id=${coupon_code_record_id}  coupon_code_record_id/remark=${coupon_code_record_id/remark}
...
patch admin coupon code records remark by coupon code record id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin coupon code records remark by coupon code record id Fail 422  ${essential_params}  ${unessential_params}    coupon_code_record_id=${coupon_code_record_id}  coupon_code_record_id/remark=${coupon_code_record_id/remark}  success=False
...
delete admin coupon code records by coupon code record id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   delete admin coupon code records by coupon code record id Fail 404    coupon_code_record_id=${w}  coupon_code_record_id/remark=${r}
...
delete admin coupon code records by coupon code record id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   delete admin coupon code records by coupon code record id Success 204    coupon_code_record_id=${coupon_code_record_id}  coupon_code_record_id/remark=${coupon_code_record_id/remark}
