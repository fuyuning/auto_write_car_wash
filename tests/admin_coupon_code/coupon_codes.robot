...
post admin coupon code records Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  coupon_pool_id=${coupon_pool_id}  created_number=${created_number}  
   ${unessential_params}  create dictionary  is_new_user=False  
...
post admin coupon code records Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  coupon_pool_id=${coupon_pool_id_422}  created_number=${created_number_422}  
   ${unessential_params}  create dictionary  is_new_user=ThisIsRobot!  
...
get admin coupon code records Success 
   ...
   ${unessential_params}  create dictionary  coupon_code_name=${coupon_code_name}  coupon_code_remark=${coupon_code_remark}  page_num=${page_num}  page_size=${page_size}  
...
get admin coupon code records Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_code_name=${coupon_code_name_422}  coupon_code_remark=${coupon_code_remark_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
get admin coupon codes Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_code_record_id=${coupon_code_record_id}  coupon_code_no=${coupon_code_no}  user_id=${user_id}  mobile=${mobile}  status=${status}  car_id=${car_id}  page_num=${page_num}  page_size=${page_size}  
...
get admin coupon codes Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_code_record_id=${coupon_code_record_id_422}  coupon_code_no=${coupon_code_no_422}  user_id=${user_id_422}  mobile=${mobile_422}  status=${status_422}  car_id=${car_id_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
patch admin coupon code records remark by coupon code record id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   patch admin coupon code records remark by coupon code record id fail 404     coupon_code_record_id=${wrong_url_id}  coupon_code_remark=${coupon_code_remark}    
...
patch admin coupon code records remark by coupon code record id Success 
   ...
   [Tags]           Respcode:204
   ${essential_params}  create dictionary  coupon_code_remark=${coupon_code_remark}  
...
patch admin coupon code records remark by coupon code record id Fail With Wrong Params
   ...
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  coupon_code_remark=${coupon_code_remark_422}  
   ${unessential_params}  create dictionary  
