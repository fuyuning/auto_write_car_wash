...
Get coupon_code Fail Without Login
...
Get coupon_code Fail With Wrong Params
   [Documentation]  接口名:优惠码列表${\n}
   ...              请求方式:Get${\n}
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
...
Get coupon_code By Id Fail With Wrong Url
   [Documentation]  接口名:导出优惠码${\n}
   ...              请求方式:Get${\n}
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   Get coupon codes export By Id Fail 404  coupon_code_record_id=${wrong_url_id}



Get coupon_code By Id Fail Without Login
   [Documentation]  接口名:导出优惠码${\n}
   ...              请求方式:Get${\n}
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   Get coupon codes export By Id Fail 403  coupon_code_record_id=${coupon_code_record_id}



Get coupon_code By Id Success 
   [Documentation]  接口名:导出优惠码${\n}
   ...              请求方式:Get${\n}
   ...              预期结果:输入正确参数,http响应码返回 200,返回的Json数据为  对象。
   [Tags]           Respcode:200
   Get coupon codes export By Id Success 200  coupon_code_record_id=${coupon_code_record_id}



Patch coupon_code By Id Success 
   ...
   run every case by params  Patch admin coupon code records By Id Success 204  ${essential_params}  ${unessential_params}  coupon_code_record_id/remark=${coupon_code_record_id/remark}



Patch coupon_code By Id Fail With Wrong Url
   [Documentation]  接口名:备注${\n}
   ...              请求方式:Patch${\n}
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   ${essential_params}  create list  coupon_code_remark=${coupon_code_remark}  
   ${unessential_params}  create list  
   run every case by params  Patch admin coupon code records By Id Fail 404  ${essential_params}  ${unessential_params}  coupon_code_record_id/remark=${wrong_url_id}



Patch coupon_code By Id Fail Without Login
   [Documentation]  接口名:备注${\n}
   ...              请求方式:Patch${\n}
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   ${essential_params}  create list  coupon_code_remark=${coupon_code_remark}  
   ${unessential_params}  create list  
   run every case by params  Patch admin coupon code records By Id Fail 403  ${essential_params}  ${unessential_params}  coupon_code_record_id/remark=${coupon_code_record_id/remark}



Patch coupon_code By Id Fail With Wrong Params
   [Documentation]  接口名:备注${\n}
   ...              请求方式:Patch${\n}
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create list  coupon_code_remark=${coupon_code_remark}  
   ${unessential_params}  create list  
   run every case by params  Patch admin coupon code records By Id Fail 422  ${essential_params}  ${unessential_params}  coupon_code_record_id/remark=${coupon_code_record_id/remark}



Delete coupon_code By Id Success 
   [Documentation]  接口名:删除优惠码${\n}
   ...              请求方式:Delete${\n}
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   Delete admin coupon code records By Id Success 204  coupon_code_record_id=${coupon_code_record_id}



Delete coupon_code By Id Fail With Wrong Url
   [Documentation]  接口名:删除优惠码${\n}
   ...              请求方式:Delete${\n}
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   Delete admin coupon code records By Id Fail 404  coupon_code_record_id=${wrong_url_id}



Delete coupon_code By Id Fail Without Login
   [Documentation]  接口名:删除优惠码${\n}
   ...              请求方式:Delete${\n}
   ...              预期结果:未登录,http响应码返回 403,无Json数据返回。
   [Tags]           Respcode:403
   Delete admin coupon code records By Id Fail 403  coupon_code_record_id=${coupon_code_record_id}
...
Get Coupon codes export By Id Fail 404
   [Arguments]  &{kwargs}
   ${resp}=  get coupon codes export by coupon code record id  &{kwargs}
   expect status is 404  ${resp}  

Get Coupon codes export By Id Fail 403
   [Arguments]  &{kwargs}
   ${resp}=  get coupon codes export by coupon code record id  &{kwargs}
   expect status is 403  ${resp}  

Get Coupon codes export By Id Success 200
   [Arguments]  &{kwargs}
   ${resp}=  get coupon codes export by coupon code record id  &{kwargs}
   expect status is 200  ${resp}  admin_coupon_code/Get_Coupon_codes_export_By_Id_200.json
   ${coupon_code_record_id}  set variable if  ${resp.json()}!=[]  ${resp.json()[0][coupon_code_record_id]}
   set global variable   ${coupon_code_record_id}
   ${coupon_code_record_id/remark}  set variable if  ${resp.json()}!=[]  ${resp.json()[0][coupon_code_record_id/remark]}
   set global variable   ${coupon_code_record_id/remark}

Patch Admin coupon code records By Id Success 204
   [Arguments]  &{kwargs}
   ${resp}=  patch remark by coupon code record id  &{kwargs}
   expect status is 204  ${resp}  

Patch Admin coupon code records By Id Fail 404
   [Arguments]  &{kwargs}
   ${resp}=  patch remark by coupon code record id  &{kwargs}
   expect status is 404  ${resp}  

Patch Admin coupon code records By Id Fail 403
   [Arguments]  &{kwargs}
   ${resp}=  patch remark by coupon code record id  &{kwargs}
   expect status is 403  ${resp}  

Patch Admin coupon code records By Id Fail 422
   [Arguments]  &{kwargs}
   ${resp}=  patch remark by coupon code record id  &{kwargs}
   expect status is 422  ${resp}  

Delete Admin coupon code records By Id Success 204
   [Arguments]  &{kwargs}
   ${resp}=  delete admin coupon code records by coupon code record id  &{kwargs}
   expect status is 204  ${resp}  

Delete Admin coupon code records By Id Fail 404
   [Arguments]  &{kwargs}
   ${resp}=  delete admin coupon code records by coupon code record id  &{kwargs}
   expect status is 404  ${resp}  

Delete Admin coupon code records By Id Fail 403
   [Arguments]  &{kwargs}
   ${resp}=  delete admin coupon code records by coupon code record id  &{kwargs}
   expect status is 403  ${resp}  
