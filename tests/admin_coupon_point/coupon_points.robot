...
post admin coupon point autos Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  coupon_pool_id=${coupon_pool_id}  record_num_last_30_day=${record_num_last_30_day}  average_price_last_30_day=${average_price_last_30_day}  wash_interval=${wash_interval}  user_type=${user_type}  
   ${unessential_params}  create dictionary  is_record_num_last_30_day=False  is_average_price_last_30_day=False  is_wash_interval=False  enable=False  is_short_message_template=False  
...
post admin coupon point autos Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  coupon_pool_id=${coupon_pool_id_422}  record_num_last_30_day=${record_num_last_30_day_422}  average_price_last_30_day=${average_price_last_30_day_422}  wash_interval=${wash_interval_422}  user_type=${user_type_422}  
   ${unessential_params}  create dictionary  is_record_num_last_30_day=ThisIsRobot!  is_average_price_last_30_day=ThisIsRobot!  is_wash_interval=ThisIsRobot!  enable=ThisIsRobot!  is_short_message_template=ThisIsRobot!  
...
post admin coupon point records upload Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  coupon_pool_id=${coupon_pool_id}  
...
post admin coupon point records upload Fail With Wrong Params
   ...
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  coupon_pool_id=${coupon_pool_id_422}  
   ${unessential_params}  create dictionary  
...
get admin coupon point autos Success 
   ...
   ${unessential_params}  create dictionary  coupon_name=${coupon_name}  created_section=${created_section}  page_num=${page_num}  page_size=${page_size}  
...
get admin coupon point autos Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_name=${coupon_name_422}  created_section=${created_section_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
get admin coupon point records Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_name=${coupon_name}  point_remark=${point_remark}  created_section=${created_section}  page_num=${page_num}  page_size=${page_size}  
...
get admin coupon point records Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_name=${coupon_name_422}  point_remark=${point_remark_422}  created_section=${created_section_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
get admin coupon points Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_point_record_id=${coupon_point_record_id}  coupon_point_auto_id=${coupon_point_auto_id}  auto_coupon_point=False  user_id=${user_id}  mobile=${mobile}  status=${status}  is_used=${is_used}  page_num=${page_num}  page_size=${page_size}  
...
get admin coupon points Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  coupon_point_record_id=${coupon_point_record_id_422}  coupon_point_auto_id=${coupon_point_auto_id_422}  auto_coupon_point=ThisIsRobot!  user_id=${user_id_422}  mobile=${mobile_422}  status=${status_422}  is_used=${is_used_422}  page_num=${page_num_422}  page_size=${page_size_422}  
   run every case by params   get admin coupon points fail 422   ${essential_params}  ${unessential_params}  success=False

patch admin coupon point autos enabled by coupon point auto id Success 
   ...
   run every case by params   patch admin coupon point autos enabled by coupon point auto id success 204   ${essential_params}  ${unessential_params}    coupon_point_auto_id=${coupon_point_auto_id}

patch admin coupon point autos enabled by coupon point auto id Fail With Wrong Url
   [Documentation]  接口名:自动定向发券启用${\n}
   ...              请求方式:Patch${\n}
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   patch admin coupon point autos enabled by coupon point auto id fail 404     coupon_point_auto_id=${wrong_url_id}    enabled=False  

patch admin coupon point autos enabled by coupon point auto id Fail With Wrong Params
   [Documentation]  接口名:自动定向发券启用${\n}
   ...              请求方式:Patch${\n}
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ...
   run every case by params   patch admin coupon point autos enabled by coupon point auto id fail 422   ${essential_params}  ${unessential_params}    coupon_point_auto_id=${coupon_point_auto_id}  success=False
...
patch admin coupon point records by coupon point record id Success 
   ...
   [Tags]           Respcode:204
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  point_remark=${point_remark}  
...
patch admin coupon point records by coupon point record id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   patch admin coupon point records by coupon point record id fail 404     coupon_point_record_id=${wrong_url_id}    point_remark=${point_remark}  
...
patch admin coupon point records by coupon point record id Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  point_remark=${point_remark_422}  
   run every case by params   patch admin coupon point records by coupon point record id fail 422   ${essential_params}  ${unessential_params}    coupon_point_record_id=${coupon_point_record_id}  success=False
...
patch admin coupon point autos enabled by coupon point auto id Success 204
   [Arguments]  &{kwargs}
   ${resp}=  patch admin coupon point autos enabled by coupon point auto id  &{kwargs}
   expect status is 204  ${resp}  

patch admin coupon point autos enabled by coupon point auto id Fail 404
   [Arguments]  &{kwargs}
   ${resp}=  patch admin coupon point autos enabled by coupon point auto id  &{kwargs}
   expect status is 404  ${resp}  

patch admin coupon point autos enabled by coupon point auto id Fail 422
   [Arguments]  &{kwargs}
   ${resp}=  patch admin coupon point autos enabled by coupon point auto id  &{kwargs}
   expect status is 422  ${resp}  
