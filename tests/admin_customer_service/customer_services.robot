...
post admin customer services finish by customer service id Fail With Wrong Url
   ...
   run every case by params  post admin customer services finish by customer service id Fail 404  ${essential_params}  ${unessential_params}    customer_service_id/finish=${w}  customer_service_id=${r}
...
post admin customer services finish by customer service id Success 
   ...
   ${essential_params}  create list  opinion=${opinion}  is_refund=${is_refund}  
   ${unessential_params}  create list  
   run every case by params  post admin customer services finish by customer service id Success 204  ${essential_params}  ${unessential_params}    customer_service_id/finish=${customer_service_id/finish}  customer_service_id=${customer_service_id}
...
post admin customer services finish by customer service id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  post admin customer services finish by customer service id Fail 422  ${essential_params}  ${unessential_params}    customer_service_id/finish=${customer_service_id/finish}  customer_service_id=${customer_service_id}  success=False
...
get admin customer services by customer service id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   get admin customer services by customer service id Fail 404    customer_service_id/finish=${w}  customer_service_id=${r}
...
get admin customer services by customer service id Success 
   ...
   [Tags]           Respcode:200
   get admin customer services by customer service id Success 200    customer_service_id/finish=${customer_service_id/finish}  customer_service_id=${customer_service_id}
...
delete admin customer services by customer service id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   delete admin customer services by customer service id Success 204    customer_service_id/finish=${customer_service_id/finish}  customer_service_id=${customer_service_id}
...
delete admin customer services by customer service id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   delete admin customer services by customer service id Fail 404    customer_service_id/finish=${w}  customer_service_id=${r}
