...
post admin parkings Fail With Wrong Params
   ...
   ${unessential_params}  create dictionary  banners=${banners_422}  service_introduce=${service_introduce_422}  
...
post admin parkings Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  banners=${banners}  service_introduce=${service_introduce}  
...
put admin home page banners by home page banner id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   put admin home page banners by home page banner id fail 404     home_page_banner_id=${wrong_url_id}    banners=${banners}  service_introduce=${service_introduce}  
