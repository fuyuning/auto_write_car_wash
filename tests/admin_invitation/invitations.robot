...
get admin invitations Success 
   ...
   ${unessential_params}  create dictionary  userid=${userid}  invited_userid=${invited_userid}  first_car_id=${first_car_id}  first_mobile=${first_mobile}  page_num=${page_num}  page_size=${page_size}  
...
get admin invitations Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  userid=${userid_422}  invited_userid=${invited_userid_422}  first_car_id=${first_car_id_422}  first_mobile=${first_mobile_422}  page_num=${page_num_422}  page_size=${page_size_422}  
