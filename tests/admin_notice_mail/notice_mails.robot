...
post admin notice mails Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  notice_mail=${notice_mail_422}  
   ${unessential_params}  create dictionary  comment_status=ThisIsRobot!  money_status=ThisIsRobot!  car_move_qrcode_status=ThisIsRobot!  wxmp_remark_status=ThisIsRobot!  washer_remark_status=ThisIsRobot!  
...
post admin notice mails Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  notice_mail=${notice_mail}  
   ${unessential_params}  create dictionary  comment_status=False  money_status=False  car_move_qrcode_status=False  wxmp_remark_status=False  washer_remark_status=False  
...
patch admin notice mails (comment status|money status|car move qrcode status|wxmp remark status|washer remark status) by notice mail id Success 
   ...
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  comment_status=False  money_status=False  car_move_qrcode_status=False  wxmp_remark_status=False  washer_remark_status=False  
   run every case by params   patch admin notice mails (comment status|money status|car move qrcode status|wxmp remark status|washer remark status) by notice mail id success 204   ${essential_params}  ${unessential_params}    notice_mail_id=${notice_mail_id}
...
patch admin notice mails (comment status|money status|car move qrcode status|wxmp remark status|washer remark status) by notice mail id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   patch admin notice mails (comment status|money status|car move qrcode status|wxmp remark status|washer remark status) by notice mail id fail 404     notice_mail_id=${wrong_url_id}    comment_status=False  money_status=False  car_move_qrcode_status=False  wxmp_remark_status=False  washer_remark_status=False  
...
patch admin notice mails (comment status|money status|car move qrcode status|wxmp remark status|washer remark status) by notice mail id Fail With Wrong Params
   ...
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  comment_status=ThisIsRobot!  money_status=ThisIsRobot!  car_move_qrcode_status=ThisIsRobot!  wxmp_remark_status=ThisIsRobot!  washer_remark_status=ThisIsRobot!  
   run every case by params   patch admin notice mails (comment status|money status|car move qrcode status|wxmp remark status|washer remark status) by notice mail id fail 422   ${essential_params}  ${unessential_params}    notice_mail_id=${notice_mail_id}  success=False
