...
get admin parkings by parking id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   get admin parkings by parking id Fail 404    parking_id=${w}  parking_id/enabled=${r}
...
get admin parkings by parking id Success 
   ...
   [Tags]           Respcode:200
   get admin parkings by parking id Success 200    parking_id=${parking_id}  parking_id/enabled=${parking_id/enabled}
...
put admin parkings by parking id Success 
   ...
   ${essential_params}  create list  parking_name=${parking_name}  position=${position}  
   ${unessential_params}  create list  alias_name=${alias_name}  wash_area_id=${wash_area_id}  out_parking_id=${out_parking_id}  enabled=False  lon=${lon}  lat=${lat}  parking_banners=${parking_banners}  use_home_banner=False  service_introduce=${service_introduce}  address=${address}  use_home_illustrate=False  province=${province}  city=${city}  district=${district}  
   run every case by params  put admin parkings by parking id Success 204  ${essential_params}  ${unessential_params}    parking_id=${parking_id}  parking_id/enabled=${parking_id/enabled}
...
put admin parkings by parking id Fail With Wrong Url
   ...
   ${essential_params}  create list  parking_name=${parking_name}  position=${position}  
   ${unessential_params}  create list  alias_name=${alias_name}  wash_area_id=${wash_area_id}  out_parking_id=${out_parking_id}  enabled=False  lon=${lon}  lat=${lat}  parking_banners=${parking_banners}  use_home_banner=False  service_introduce=${service_introduce}  address=${address}  use_home_illustrate=False  province=${province}  city=${city}  district=${district}  
   run every case by params  put admin parkings by parking id Fail 404  ${essential_params}  ${unessential_params}    parking_id=${w}  parking_id/enabled=${r}
...
put admin parkings by parking id Fail With Wrong Params
   ...
   ${essential_params}  create list  parking_name=${parking_name_422}  position=${position_422}  
   ${unessential_params}  create list  alias_name=${alias_name_422}  wash_area_id=${wash_area_id_422}  out_parking_id=${out_parking_id_422}  enabled=ThisIsRobot!  lon=${lon_422}  lat=${lat_422}  parking_banners=${parking_banners_422}  use_home_banner=ThisIsRobot!  service_introduce=${service_introduce_422}  address=${address_422}  use_home_illustrate=ThisIsRobot!  province=${province_422}  city=${city_422}  district=${district_422}  
   run every case by params  put admin parkings by parking id Fail 422  ${essential_params}  ${unessential_params}    parking_id=${parking_id}  parking_id/enabled=${parking_id/enabled}  success=False
...
patch admin parkings enabled by parking id Fail With Wrong Url
   ...
   run every case by params  patch admin parkings enabled by parking id Fail 404  ${essential_params}  ${unessential_params}    parking_id=${w}  parking_id/enabled=${r}
...
patch admin parkings enabled by parking id Success 
   ...
   ${essential_params}  create list  enabled=False  
   ${unessential_params}  create list  
   run every case by params  patch admin parkings enabled by parking id Success 204  ${essential_params}  ${unessential_params}    parking_id=${parking_id}  parking_id/enabled=${parking_id/enabled}
...
patch admin parkings enabled by parking id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin parkings enabled by parking id Fail 422  ${essential_params}  ${unessential_params}    parking_id=${parking_id}  parking_id/enabled=${parking_id/enabled}  success=False
...
delete admin parkings by parking id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   delete admin parkings by parking id Fail 404    parking_id=${w}  parking_id/enabled=${r}
...
delete admin parkings by parking id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   delete admin parkings by parking id Success 204    parking_id=${parking_id}  parking_id/enabled=${parking_id/enabled}
