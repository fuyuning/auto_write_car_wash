...
post admin promoters Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  promoter_no=${promoter_no}  
   ${unessential_params}  create dictionary  name=${name}  mobile=${mobile}  promoter_remark=${promoter_remark}  enabled=False  
...
post admin promoters Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  promoter_no=${promoter_no_422}  
   ${unessential_params}  create dictionary  name=${name_422}  mobile=${mobile_422}  promoter_remark=${promoter_remark_422}  enabled=ThisIsRobot!  
...
get admin promoters Fail With Wrong Params
   ...
   ${unessential_params}  create dictionary  name=${name_422}  mobile=${mobile_422}  promoter_remark=${promoter_remark_422}  
...
get admin promoters Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  name=${name}  mobile=${mobile}  promoter_remark=${promoter_remark}  
...
get admin promotions Fail With Wrong Params
   ...
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  promoter_id=${promoter_id_422}  
   ${unessential_params}  create dictionary  user_id=${user_id_422}  mobile=${mobile_422}  car_id=${car_id_422}  created_section=${created_section_422}  
...
get admin promotions Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  promoter_id=${promoter_id}  
   ${unessential_params}  create dictionary  user_id=${user_id}  mobile=${mobile}  car_id=${car_id}  created_section=${created_section}  
...
get admin promotion count Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  promoter_id=${promoter_id}  created_section=${created_section}  
...
get admin promotion count Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  promoter_id=${promoter_id_422}  created_section=${created_section_422}  
...
put admin promoters by promoter id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   put admin promoters by promoter id fail 404     promoter_id=${wrong_url_id}    name=${name}  mobile=${mobile}  promoter_remark=${promoter_remark}  enabled=False  
...
patch admin promoters enabled by promoter id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   patch admin promoters enabled by promoter id fail 404     promoter_id=${wrong_url_id}    enabled=False  
