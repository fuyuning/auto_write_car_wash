...
get admin promoter statistics Success 
   ...
   ${unessential_params}  create dictionary  promoter_no=${promoter_no}  name=${name}  mobile=${mobile}  section=${section}  order_by=${order_by}  page_num=${page_num}  page_size=${page_size}  
...
get admin promoter statistics Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  promoter_no=${promoter_no_422}  name=${name_422}  mobile=${mobile_422}  section=${section_422}  order_by=${order_by_422}  page_num=${page_num_422}  page_size=${page_size_422}  
...
patch admin promoter statistics visible by promoter statistic id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   patch admin promoter statistics visible by promoter statistic id fail 404     promoter_statistic_id=${wrong_url_id}  visible=False    
