...
post admin robots Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  mobile=${mobile}  name=${name}  car_id=${car_id}  
...
post admin robots Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  mobile=${mobile_422}  name=${name_422}  car_id=${car_id_422}  
   ${unessential_params}  create dictionary  
...
get admin robots Success 
   ...
   ${unessential_params}  create dictionary  mobile=${mobile}  car_id=${car_id}  page_num=${page_num}  page_size=${page_size}  
...
get admin robots Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  mobile=${mobile_422}  car_id=${car_id_422}  page_num=${page_num_422}  page_size=${page_size_422}  
