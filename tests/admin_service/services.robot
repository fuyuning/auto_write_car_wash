...
post admin services Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  service_name=${service_name_422}  cost_price=${cost_price_422}  price=${price_422}  wash_normal_price=${wash_normal_price_422}  wash_group_price=${wash_group_price_422}  member_price=${member_price_422}  commission_price=${commission_price_422}  standard_time=${standard_time_422}  
   ${unessential_params}  create dictionary  description=${description_422}  order_by=${order_by_422}  
...
post admin services Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  service_name=${service_name}  cost_price=${cost_price}  price=${price}  wash_normal_price=${wash_normal_price}  wash_group_price=${wash_group_price}  member_price=${member_price}  commission_price=${commission_price}  standard_time=${standard_time}  
   ${unessential_params}  create dictionary  description=${description}  order_by=${order_by}  
