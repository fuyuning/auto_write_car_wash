...
get admin turntables by turntable id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   get admin turntables by turntable id Fail 404    turntable_id=${w}  turntable_id/enabled=${r}
...
get admin turntables by turntable id Success 
   ...
   [Tags]           Respcode:200
   get admin turntables by turntable id Success 200    turntable_id=${turntable_id}  turntable_id/enabled=${turntable_id/enabled}
...
put admin turntables by turntable id Fail With Wrong Url
   ...
   ${essential_params}  create list  name=${name}  wash_user_group_ids=${wash_user_group_ids}  prizes=${Please_input}  enabled=False  
   ${unessential_params}  create list  
   run every case by params  put admin turntables by turntable id Fail 404  ${essential_params}  ${unessential_params}    turntable_id=${w}  turntable_id/enabled=${r}
...
put admin turntables by turntable id Success 
   ...
   ${essential_params}  create list  name=${name}  wash_user_group_ids=${wash_user_group_ids}  prizes=${Please_input}  enabled=False  
   ${unessential_params}  create list  
   run every case by params  put admin turntables by turntable id Success 204  ${essential_params}  ${unessential_params}    turntable_id=${turntable_id}  turntable_id/enabled=${turntable_id/enabled}
...
put admin turntables by turntable id Fail With Wrong Params
   ...
   ${essential_params}  create list  name=${name_422}  wash_user_group_ids=${wash_user_group_ids_422}  prizes=${Please_input}  enabled=ThisIsRobot!  
   ${unessential_params}  create list  
   run every case by params  put admin turntables by turntable id Fail 422  ${essential_params}  ${unessential_params}    turntable_id=${turntable_id}  turntable_id/enabled=${turntable_id/enabled}  success=False
...
patch admin turntables enabled by turntable id Fail With Wrong Url
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin turntables enabled by turntable id Fail 404  ${essential_params}  ${unessential_params}    turntable_id=${w}  turntable_id/enabled=${r}
...
patch admin turntables enabled by turntable id Success 
   ...
   ${essential_params}  create list  enabled=False  
   ${unessential_params}  create list  
   run every case by params  patch admin turntables enabled by turntable id Success 204  ${essential_params}  ${unessential_params}    turntable_id=${turntable_id}  turntable_id/enabled=${turntable_id/enabled}
...
patch admin turntables enabled by turntable id Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  patch admin turntables enabled by turntable id Fail 422  ${essential_params}  ${unessential_params}    turntable_id=${turntable_id}  turntable_id/enabled=${turntable_id/enabled}  success=False
...
delete admin turntables by turntable id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   delete admin turntables by turntable id Fail 404    turntable_id=${w}  turntable_id/enabled=${r}
...
delete admin turntables by turntable id Success 
   ...
   ...              预期结果:输入正确参数,http响应码返回 204,无Json数据返回。
   [Tags]           Respcode:204
   delete admin turntables by turntable id Success 204    turntable_id=${turntable_id}  turntable_id/enabled=${turntable_id/enabled}
