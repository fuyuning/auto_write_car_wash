...
get admin wash comments Success 
   ...
   ${unessential_params}  create dictionary  order_no=${order_no}  user_id=${user_id}  car_id=${car_id}  mobile=${mobile}  level=${level}  created_section=${created_section}  page_num=${page_num}  page_size=${page_size}  
...
get admin wash comments Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  order_no=${order_no_422}  user_id=${user_id_422}  car_id=${car_id_422}  mobile=${mobile_422}  level=${level_422}  created_section=${created_section_422}  page_num=${page_num_422}  page_size=${page_size_422}  
