...
get admin wash record statistics by day Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create list  
   ${unessential_params}  create list  parking_id=${parking_id_422}  wash_area_id=${wash_area_id_422}  order_by=${order_by_422}  section=${section_422}  page_num=${page_num_422}  page_size=${page_size_422}  
