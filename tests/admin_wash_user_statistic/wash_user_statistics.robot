...
patch admin wash user statistics visible by wash user statistic id Fail With Wrong Url
   ...
   run every case by params  patch admin wash user statistics visible by wash user statistic id Fail 404  ${essential_params}  ${unessential_params}    wash_user_statistic_id=${wrong_url_id}
