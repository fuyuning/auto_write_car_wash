...
Put Admin Wechat Menus Fail Without Login
   ...
   run every case by params  Put Admin Wechat Menus Fail 403  ${essential_params}  ${unessential_params}
...
Put Admin Wechat Menus Fail 403
   [Arguments]  &{kwargs}
