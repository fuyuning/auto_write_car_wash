...
Post Admin Wechat Replys Fail With Wrong Params
   ...
   ${unessential_params}  create list  
   run every case by params  Post Admin Wechat Replys Fail 422  ${essential_params}  ${unessential_params}
...
Put Admin Wechat Replys By Wechat Reply Id Fail With Wrong Params
   ...
   ${essential_params}  create list  category=${category_422}  reply_type=${reply_type_422}  content=${content_422}  
   ${unessential_params}  create list  
   run every case by params  Put Admin Wechat Replys By Wechat Reply Id Fail 422  ${essential_params}  ${unessential_params}  wechat_reply_id=${wechat_reply_id}
