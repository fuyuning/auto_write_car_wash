...
post admin wechat replys Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  category=${category}  reply_type=${reply_type}  content=${content}  
...
post admin wechat replys Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  category=${category_422}  reply_type=${reply_type_422}  content=${content_422}  
   ${unessential_params}  create dictionary  
...
put admin wechat replys by wechat reply id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   put admin wechat replys by wechat reply id fail 404     wechat_reply_id=${wrong_url_id}  category=${category}  reply_type=${reply_type}  content=${content}    
