...
post oauth 2.0 token Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  grant_type=${grant_type}  client_id=${Please_input}  secret=${Please_input}  userid=${userid}  password=${Please_input}  
...
post oauth 2.0 token Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  grant_type=${grant_type_422}  client_id=${Please_input}  secret=${Please_input}  userid=${userid_422}  password=${Please_input}  
   ${unessential_params}  create dictionary  
