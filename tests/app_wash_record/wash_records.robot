...
post car wash wash records update by wash record id Fail With Wrong Url
   ...
   run every case by params  post car wash wash records update by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
post car wash wash records update by wash record id Success 
   ...
   ${essential_params}  create list  status=${status}  
   ${unessential_params}  create list  before_wash_images=${before_wash_images}  after_wash_images=${after_wash_images}  wash_tags=${wash_tags}  description=${description}  start_time=${start_time}  end_time=${end_time}  dirty_percent=${dirty_percent}  washer_remark=${washer_remark}  mark=${mark}  
   run every case by params  post car wash wash records update by wash record id Success 201  ${essential_params}  ${unessential_params}    wash_record_id=${wash_record_id}
...
post car wash wash records upload mark by wash record id Fail With Wrong Url
   ...
   run every case by params  post car wash wash records upload mark by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
post car wash wash records upload by wash record id Fail With Wrong Url
   ...
   run every case by params  post car wash wash records upload by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
post car wash wash records upload by wash record id Success 
   ...
   ${essential_params}  create list  before_wash_images=${before_wash_images}  status=${status}  after_wash_images=${after_wash_images}  start_time=${start_time}  end_time=${end_time}  dirty_percent=${dirty_percent}  
   ${unessential_params}  create list  tags=${Please_input}  description=${description}  
   run every case by params  post car wash wash records upload by wash record id Success 201  ${essential_params}  ${unessential_params}    wash_record_id=${wash_record_id}
...
post car wash wash records wash by wash record id Fail With Wrong Url
   ...
   ${unessential_params}  create list  tags=${Please_input}  description=${description}  
   run every case by params  post car wash wash records wash by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
post car wash wash records wash by wash record id Success 
   ...
   ${essential_params}  create list  before_wash_images=${before_wash_images}  
   ${unessential_params}  create list  tags=${Please_input}  description=${description}  
   run every case by params  post car wash wash records wash by wash record id Success 201  ${essential_params}  ${unessential_params}    wash_record_id=${wash_record_id}
...
post car wash wash records finish by wash record id Fail With Wrong Url
   ...
   run every case by params  post car wash wash records finish by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
patch car wash wash records washer remark by wash record id Fail With Wrong Url
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  washer_remark=${washer_remark}  
   run every case by params  patch car wash wash records washer remark by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
patch car wash wash records mark by wash record id Fail With Wrong Url
   ...
   ${essential_params}  create list  
   ${unessential_params}  create list  mark=${mark}  
   run every case by params  patch car wash wash records mark by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
...
patch car wash wash records status by wash record id Fail With Wrong Url
   ...
   ${essential_params}  create list  status=${status}  
   ${unessential_params}  create list  
   run every case by params  patch car wash wash records status by wash record id Fail 404  ${essential_params}  ${unessential_params}    wash_record_id=${wrong_url_id}
