...
get car brands Success 
   ...
   ${unessential_params}  create dictionary  popular_brand=${popular_brand}  page_num=${page_num}  page_size=${page_size}  
...
get car brands Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  popular_brand=${popular_brand_422}  page_num=${page_num_422}  page_size=${page_size_422}  
