...
post card orders pay by card order id Fail Without Login
   ...
   ${unessential_params}  create list  
   run every case by params  post card orders pay by card order id Fail 403  ${essential_params}  ${unessential_params}    card_order_id=${card_order_id}


*** Variables ***
${card_order_id}  12345678909876543
