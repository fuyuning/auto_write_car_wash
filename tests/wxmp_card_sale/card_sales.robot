...
get card sales Success 
   ...
   ${unessential_params}  create dictionary  enabled=False  page_num=${page_num}  page_size=${page_size}  
...
get card sales Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  enabled=ThisIsRobot!  page_num=${page_num_422}  page_size=${page_size_422}  
