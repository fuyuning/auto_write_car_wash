...
post user coupon pools achieve Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  coupon_pool_ids=${coupon_pool_ids}  
...
post user coupon pools achieve Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  coupon_pool_ids=${coupon_pool_ids_422}  
   ${unessential_params}  create dictionary  
...
post coupon pools achieve by mobile by coupon pool id Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  mobile=${mobile}  serie=${serie}  captcha=${captcha}  
   ${unessential_params}  create dictionary  client_id=${client_id}  secret=${secret}  
...
post coupon pools achieve by mobile by coupon pool id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   post coupon pools achieve by mobile by coupon pool id fail 404     coupon_pool_id=${wrong_url_id}  mobile=${mobile}  serie=${serie}  captcha=${captcha}    client_id=${client_id}  secret=${secret}  
...
post coupon pools achieve by mobile by coupon pool id Fail With Wrong Params
   ...
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  mobile=${mobile_422}  serie=${serie_422}  captcha=${captcha_422}  
   ${unessential_params}  create dictionary  client_id=${client_id_422}  secret=${secret_422}  
...
get user coupons usable Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  order_price=${order_price}  
   ${unessential_params}  create dictionary  wash_area_id=${wash_area_id}  service_group_id=${service_group_id}  parking_id=${parking_id}  order_type=${order_type}  service_type=${service_type}  
...
get user coupons usable Fail With Wrong Params
   ...
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  order_price=${order_price_422}  
   ${unessential_params}  create dictionary  wash_area_id=${wash_area_id_422}  service_group_id=${service_group_id_422}  parking_id=${parking_id_422}  order_type=${order_type_422}  service_type=${service_type_422}  
...
get user coupon pools by coupon pool id Fail With Wrong Url
   ...
   ...              预期结果:输入正确参数及错误的url,http响应码返回 404,无Json数据返回。
   [Tags]           Respcode:404
   get user coupon pools by coupon pool id fail 404     coupon_pool_id=${wrong_url_id}  is_point=${is_point}    
