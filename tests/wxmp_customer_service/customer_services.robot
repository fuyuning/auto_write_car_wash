...
post user customer services Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  wash_record_id=${wash_record_id_422}  reason=${reason_422}  description=${description_422}  is_refund=${is_refund_422}  
...
post user customer services Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  wash_record_id=${wash_record_id}  reason=${reason}  description=${description}  is_refund=${is_refund}  
   ${unessential_params}  create dictionary  
...
get user customer services Success 
   ...
   ${unessential_params}  create dictionary  status=${status}  page_num=${page_num}  page_size=${page_size}  
...
get user customer services Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  
   ${unessential_params}  create dictionary  status=${status_422}  page_num=${page_num_422}  page_size=${page_size_422}  
