...
get user service groups price by service group id Fail With Wrong Url
   ...
   [Tags]           Respcode:404
   get user service groups price by service group id fail 404     service_group_id=${wrong_url_id}  car_series_id=${car_series_id}    
...
get user service groups price by service group id Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  car_series_id=${car_series_id}  
...
get user service groups price by service group id Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  car_series_id=${car_series_id_422}  
   ${unessential_params}  create dictionary  
