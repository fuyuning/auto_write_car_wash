...
get user service groups price by service group id Fail Without Login
   ...
   run every case by params  get user service groups price by service group id Fail 403  ${essential_params}  ${unessential_params}    service_group_id=${service_group_id}
