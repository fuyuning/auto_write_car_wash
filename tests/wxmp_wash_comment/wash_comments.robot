...
post user wash comments Success 
   ...
   [Tags]           Respcode:201
   ${essential_params}  create dictionary  wash_record_id=${wash_record_id}  level=${level}  
   ${unessential_params}  create dictionary  car_images=${car_images}  comment_remark=${comment_remark}  
...
post user wash comments Fail With Wrong Params
   ...
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  wash_record_id=${wash_record_id_422}  level=${level_422}  
   ${unessential_params}  create dictionary  car_images=${car_images_422}  comment_remark=${comment_remark_422}  
...
get wechat image upload Success 
   ...
   [Tags]           Respcode:200
   ${essential_params}  create dictionary  media_id=${media_id}  
...
get wechat image upload Fail With Wrong Params
   ...
   ...              预期结果:输入错误参数,http响应码返回 422,返回的Json数据为错误信息。
   [Tags]           Respcode:422
   ${essential_params}  create dictionary  media_id=${media_id_422}  
   ${unessential_params}  create dictionary  
